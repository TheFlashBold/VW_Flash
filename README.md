...
[Download VW_Flash_GUI for macOS (Apple Silicon)](https://github.com/TheFlashBold/VW_Flash/releases/download/v0.7.3-macos.3/VW_Flash_GUI-macos-arm64.zip)

The macOS app is signed and notarized with Apple Developer ID. The ZIP is packaged without resource forks or AppleDouble metadata.
